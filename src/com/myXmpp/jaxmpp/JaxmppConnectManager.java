...
public class JaxmppConnectManager {
	...
	public static String domain = "etwwin7-pc";//your domain
	private static String serverIP = "192.168.2.34";//your Ip
...
//		initFriendStatusListener();
    ...
    void initFriendStatusListener() {
        jaxmpp.getModulesManager().getModule(PresenceModule.class).addListener(new Listener<PresenceEvent>() {
...
//                        updateFriends(be, User.DBFLAG_ADD);
	...
	void initChatMsgListener(){
		jaxmppConnectManager.jaxmpp.getModulesManager().getModule( MessageModule.class ).addListener(new Listener<MessageEvent>() {
